...
const generateRssItem = (config: PlinyConfig, post: Blog) => `
  <item>
...
const generateRss = (config: PlinyConfig, posts: Blog[] = [], page = 'feed.xml') => `
...
async function generateRSS(config: PlinyConfig, posts: Blog[] = [], page = 'feed.xml') {
