---
title: '웹뷰에서 네이티브 앱 설치 확인 및 앱 진입 유도하기'
summary: '웹뷰에서 네이티브 앱으로 유저 납치하기'
date: '2025-04-11'
tags: ['DEV', 'FRONTEND', 'UX']
draft: false
---

웹뷰에서 네이티브 앱으로의 전환 유도는 사용자 경험에 중요한 부분이라고 생각됩니다. 특히 인앱브라우저나 웹브라우저에서 사용자 여정(Journey)이 이루어질 때, 앱이 설치되어 있는지 확인하고 자연스럽게 앱으로 진입을 유도하는 것은 매출과 리텐션에 직접적인 영향을 미칩니다.
...
이런 API를 사용하기 위해서는 웹뷰와 네이티브 앱 간의 관계를 명시적으로 설정해야합니다.
...
웹뷰에서 네이티브 앱으로의 유도는 사용자 경험을 해치지 않는 범위 내에서 이루어져야합니다.
